...
// Resolve repo root relative to this file: docs/review/components/utils -> ../../../..
...
const OUTPUT_DIR = path.join(ROOT_DIR, 'docs', 'review', 'output');
...
const LEGACY_ANALYSIS_FILE = path.join(ROOT_DIR, 'docs', 'review', 'code_review.json');
