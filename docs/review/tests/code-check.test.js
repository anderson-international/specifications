 ...
 * Run with: node --test tests/code-check.test.js
 */
...
// Paths
const scriptPath = path.join(__dirname, '../code-check.js')
const fallbackTestDir = path.join(__dirname, '../../test/fallback-data-analyzer')
const typescriptTestDir = path.join(__dirname, '../../test/typescript-analyzer')
